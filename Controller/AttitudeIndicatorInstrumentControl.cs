...
namespace AvionicsInstrumentControlDemo
{
    class AttitudeIndicatorInstrumentControl : InstrumentControl
    {
        ...
        // Images
        Bitmap bmpCadran = new Bitmap(AspanGround_2.Properties.Resources.Horizon_Background);
        Bitmap bmpBoule = new Bitmap(AspanGround_2.Properties.Resources.Horizon_GroundSky);
        Bitmap bmpAvion = new Bitmap(AspanGround_2.Properties.Resources.Maquette_Avion);
        ...
        protected override void OnPaint(PaintEventArgs pe)
        {
            ...
            base.OnPaint(pe);
            //Console.WriteLine($"OnPaint çaðrýldý: Pitch={PitchAngle}, Roll={RollAngle}");
