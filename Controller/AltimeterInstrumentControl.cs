...
namespace AvionicsInstrumentControlDemo
{
    class AltimeterInstrumentControl : InstrumentControl
    {
        ...
        Bitmap bmpCadran = new Bitmap(AspanGround_2.Properties.Resources.Altimeter_Background);
        Bitmap bmpSmallNeedle = new Bitmap(AspanGround_2.Properties.Resources.SmallNeedleAltimeter);
        Bitmap bmpLongNeedle = new Bitmap(AspanGround_2.Properties.Resources.LongNeedleAltimeter);
        Bitmap bmpScroll = new Bitmap(AspanGround_2.Properties.Resources.Bandeau_Dérouleur);
